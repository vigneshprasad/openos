...
export const AmplitudeResourceForm: React.FC = () => {
    ...
    const mixpanelResource = api.amplitudeResource.create.useMutation({
        onSuccess: (data) => {
            if(data[0]) {
            ...
            <Dialog.Portal>
                ...
                <Dialog.Content className="DialogContent p-4">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <fieldset className="Fieldset">
                            <label className="Label">
                                <span className="text-[#242533]">API Key</span>
                                <input
                                    className="bg-slate-50 rounded-lg p-2 pl-3 w-full" 
                                    type="text"
                                    value={apiKey}
                        ...
                        <fieldset className="Fieldset">
                            <label className="Label">
                                <span className="text-[#242533]">Secret Key</span>
                                <input
                                    className="bg-slate-50 rounded-lg p-2 pl-3 w-full" 
                                    type="text"
                                    value={secretKey}
