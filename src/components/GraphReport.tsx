...
const GraphReport: React.FC<Props> = ({ props }) => {
            ...
            {data && 
                <div className="grid grid-cols-[max-content_1fr] gap-4">
                    ...
                    <div className="w-full">
                        {dataRaw.graph && 
                            <CChart
                                type={dataRaw.graph?.type === "line" ? "line" : "bar"}
                                className="text-white"
                                data={{
                                    labels: dataRaw.graph?.labels,
                                    datasets: [
                                        {
                                            label: dataRaw.graph?.title,
                                            data: dataRaw.graph?.data ? dataRaw.graph?.data : [],
