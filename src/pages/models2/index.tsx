                                                    ...
                                                    aggregateChurnByPrimaryCohortsLoading || userListLoading || !aggregateChurnByPrimaryCohorts || !userList ?
                                                        ...
                                                        <div className="grid grid-rows-[auto_1fr_auto] h-full">
                                                            <div className="border-b border-border-colour">
                                                                <div className="text-dark-text-colour font-medium my-auto p-6">Aggregate Churn by {aggregateChurnByPrimaryCohorts.cohort1.title}</div>
                                                            </div>
                                                            <div>
                                            ...
                                            <div className="bg-white drop-shadow-md rounded-lg">
                                                {
                                                    aggregateChurnByPrimaryCohortsLoading || userListLoading || !aggregateChurnByPrimaryCohorts || !userList ?
                                                        ...
                                                        <div className="grid grid-rows-[auto_1fr_auto] h-full">
                                                            <div className="border-b border-border-colour">
                                                                <div className="text-dark-text-colour font-medium my-auto p-6">Aggregate Churn by {aggregateChurnByPrimaryCohorts.cohort2.title}</div>
                                                            </div>
                                                            <div className="mb-">
